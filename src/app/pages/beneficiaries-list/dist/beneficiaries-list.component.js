...
exports.scheduleModel = exports.BeneficiariesListComponent = void 0;
...
var BeneficiariesListComponent = /** @class */ (function () {
    function BeneficiariesListComponent(dialog, service) {
        this.dialog = dialog;
    ...
    BeneficiariesListComponent.prototype.ngOnInit = function () { };
    BeneficiariesListComponent.prototype.getData = function () {
        var _this = this;
        this.showLoading = true;
        this.service.Get('beneficiaries').subscribe(function (data) {
            for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
                var item = data_1[_i];
                item.duplicated_level == 0 ? _this.count_unique += 1 : false;
                item.duplicated_level == 1 ? _this.count_review += 1 : false;
            }
            _this.service.Get('beneficiaries/count').subscribe(function (data) {
                _this.total_beneficiaries = data;
            });
    ...
    BeneficiariesListComponent.prototype.openDrawerActivities = function (data) {
        var _this = this;
        this.drawer_activities = [];
    ...
    BeneficiariesListComponent.prototype.closeDrawerActivities = function () {
        var _this = this;
    ...
    BeneficiariesListComponent.prototype.onSelect = function (_a) {
        var _b;
    ...
    BeneficiariesListComponent.prototype.filterByColumn = function (event, colName) {
        this.data = this.rows;
    ...
    BeneficiariesListComponent.prototype.filterDatatable = function (event) {
        this.data = this.rows;
        // get the value of the key pressed and make it lowercase
    ...
    BeneficiariesListComponent.prototype.add = function () {
        var _this = this;
    ...
    BeneficiariesListComponent.prototype.newMerge = function () {
        var _tempSelectedId = [];
    ...
    BeneficiariesListComponent.prototype.update = function (row) {
    };
    BeneficiariesListComponent.prototype["delete"] = function (row) {
        var _this = this;
    ...
    ], BeneficiariesListComponent.prototype, "table");
    __decorate([
        core_1.ViewChild('drawerActivities')
    ], BeneficiariesListComponent.prototype, "drawerActivities");
    __decorate([
        core_1.ViewChild('draweContent')
    ], BeneficiariesListComponent.prototype, "draweContent");
    ...
    return BeneficiariesListComponent;
}());
exports.BeneficiariesListComponent = BeneficiariesListComponent;
