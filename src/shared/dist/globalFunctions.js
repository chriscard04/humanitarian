...
var GlobalFunctions = /** @class */ (function () {
    function GlobalFunctions(translate) {
    ...
    GlobalFunctions.prototype.getAllCountries = function () {
        return this.countries;
    };
    GlobalFunctions.prototype.getCountryByISO = function (code) {
    ...
    GlobalFunctions.prototype.successMessage = function (message) {
        if (message === void 0) { message = this.translate.currentLang == 'es' ? 'Cambios guardados correctamente' : 'Changes Saved Successfully'; }
        return {
            show: true,
            status: 'primary',
            text: message
    ...
    GlobalFunctions.prototype.errorMessage = function (message) {
        if (message === void 0) { message = this.translate.currentLang == 'es' ? 'Favor completar todos los campos' : 'Please fill in all required fields'; }
        return {
            show: true,
            status: 'warn',
            text: message
